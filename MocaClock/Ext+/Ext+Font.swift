...
extension Font {
    ...
    static func setMainClockFont() -> Font {
        return Font.system(size: 75 * setFontSize())
    }
    
    static func setBodyFont() -> Font {
        return Font.system(size: 16 * setFontSize())
    }
